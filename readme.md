...
[![Python](https://img.shields.io/badge/python-3.9%2B-blue)](https://pypi.org/project/opta-sdapi/)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

Python client for the **OPTA Sports Data Soccer API (OPTA SDAPI)**.  
Supports both synchronous and  usage, response caching, automatic retries, and a CLI.
...
```bash
git clone https://github.com/MohanedAwad/opta-sd
cd opta-sd
pip install -e ".[dev]"
```
...
```python
from opta_sdapi.soccer import Match, TournamentCalendar, TeamStandings
from opta_sdapi.cache import MemoryCache
